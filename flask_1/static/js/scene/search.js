...
export default function showSearchScene() {
    ...
    time.addEventListener('change', function() {
        ...
        button.addEventListener('click', function(e) {
            ...
            // console.log(shirt_feature)
            selectPersonInformation(shirt_feature);  // Add this function call
...
function selectPersonInformation(featureData){
    ...
    // 取得查詢資訊
    axios.post('http://127.0.0.1:5000/selectPersonInformation/info', Qs.stringify(data))
    .then(response => {
        ...
        const imagePromises = personInformation.map(data => {
            return axios.get(`http://127.0.0.1:5000/get_image_url/${data[0]}`)
                .then(response_picture_url => {
                    ...
                    return `<div id="SearchInformationScene">
